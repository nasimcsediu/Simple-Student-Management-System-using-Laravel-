...
/// eee studen show==================================
    ...
    /// civil studen show=================================
     public function civil(){
      $civilstudent_info=DB::table('student_tbl')->where(['student_department'=>3])->get();
     ...
     /// bba studen show======================================
     public function bba(){
      $bbastudent_info=DB::table('student_tbl')->where(['student_department'=>4])->get();
...
//save student=====================================================
    public function addstudent(Request $request){
       ...
       Session::put('message','add student successful');
...
public function studentsview($student_id){
 $student_des_view =  DB::table('student_tbl')->select('*')->where('stuent_id',$student_id)->first();
